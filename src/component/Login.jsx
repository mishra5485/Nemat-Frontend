...
const Login = () => {
  ...
  return (
    <div className=" md:w-full flex min-h-screen overflow-hidden  md:flex-row lg:flex h-[100vh] sm:w-full sm:flex-col">
      <Toaster />

      <div className="sm:flex sm:flex-col sm:w-full sm:h-[15000px] md:flex md:h-full md:min-w-[45%] ">
        <div className="overflow-hidden flex relative h-[100vh] w-full">
          <div
            style={{ backgroundImage: `url(${loginBG})` }}
            className="w-[100vh] object-cover bg-cover  flex-wrap bg-no-repeat bg-center"
          >
      ...
      <div className="overflow-hidden min w-28 sm:rotate-90 md:rotate-0">
        <InfiniteScrollImage />
      </div>
      <div className="w-full h-full">
        <div className="w-full h-full flex justify-center items-center">
          <div className="w-[90%] h-[80%] flex flex-col justify-">
            <h2 className="text-4xl mb-5 leading-tight text-[#642F29]  font-roxborough">
                ...
                >
                  <div className="space-y-5">
                    <div>
                      <label
                        htmlFor=""
                        className="text-lg font-Marcellus  text-[#642F29]"
                      >
                        {" "}
                        Username{" "}
                      </label>
                    ...
                    <div>
                      <p className=" text-sm font-Marcellus text-[#642F29] mt-[20px] gap-6">
                        <Link
                          to="/companydetails"
                          title=""
                      ...
                      {/* <button
                        type="submit"
                        className="inline-flex w-[179px] h-[43px]  mt-9 items-center justify-center  rounded-3xl bg-[#60713A]  leading-7 text-white font-marcellus text-base  leading-17 tracking-normal text-center hover:animate-pulse hover:bg-"
                      >
                        LOG IN
                      </button> */}
                      <Btn_Text width="179px" height="43px" text="LOG IN" type="submit" />
